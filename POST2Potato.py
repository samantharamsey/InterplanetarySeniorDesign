...
Determines if there are any post-AGA cases in the POST data that meet the
science orbit requirements in 3D potato.

Required:
    C:\Senior_Design\TitanAGAMission\Data\PostData\tin7_2.xlsx (or other POST data)
    C:\Senior_Design\TitanAGAMission\Data\PotatoData\3D_potato.hdf
Creates:
    C:\Senior_Design\TitanAGAMission\Data\PotatoData\3D_potato_extended.hdf
'''
