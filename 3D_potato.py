...
def plot_single_inclination(inclination, gamma):
    ...
    *** Use this to see a single inclination curve ***
    ...
    X_green = data3['Saturn v1 max'] * np.cos(data3['Saturn inclination (deg)'] * (np.pi / 180)) * np.sin(
        data3['Saturn fpa (deg)'] * (np.pi / 180))
    Y_green = data3['Saturn v1 max'] * np.cos(data3['Saturn inclination (deg)'] * (np.pi / 180)) * np.cos(
        data3['Saturn fpa (deg)'] * (np.pi / 180))
    Z_green = data3['Saturn v1 max'] * np.sin(data3['Saturn inclination (deg)'] * (np.pi / 180))
    X_orange = data4['Saturn v1 max'] * np.cos(data4['Saturn inclination (deg)'] * (np.pi / 180)) * np.sin(
        data4['Saturn fpa (deg)'] * (np.pi / 180))
    Y_orange = data4['Saturn v1 max'] * np.cos(data4['Saturn inclination (deg)'] * (np.pi / 180)) * np.cos(
        data4['Saturn fpa (deg)'] * (np.pi / 180))
    Z_orange = data4['Saturn v1 max'] * np.sin(data4['Saturn inclination (deg)'] * (np.pi / 180))
    X_red = data5['Saturn v1 max'] * np.cos(data5['Saturn inclination (deg)'] * (np.pi / 180)) * np.sin(
        data5['Saturn fpa (deg)'] * (np.pi / 180))
    Y_red = data5['Saturn v1 max'] * np.cos(data5['Saturn inclination (deg)'] * (np.pi / 180)) * np.cos(
        data5['Saturn fpa (deg)'] * (np.pi / 180))
...
def referenceframe_transformation():
    ...
    *** Appends to DataFrame - will not overwrite columns ***
    ...
    vy_max = data['Saturn v1 max'] * np.cos(data['Saturn inclination (deg)'] * (np.pi / 180)) * np.cos(
        data['Saturn fpa (deg)'] * (np.pi / 180))
