...
Patches between the interplanetary trajectory outbound condition which are
relative to Saturn and the input condition for POST which are relative to
Titan.

Runs as-is. Have to manually enter MAnE conditions.
Should probably automate this in the future.
'''
